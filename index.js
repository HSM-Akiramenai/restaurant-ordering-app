...
function renderMenu(menuItems){
    ...
    document.getElementById('menu-section').innerHTML = menuItems.map((menuItem) => {
...
function addItemToCheckoutArray(menuItemId){
    ...
    const alreadyExistingItem = checkoutArray.find((checkoutItem) => 
    checkoutItem.id === itemToAdd.id)
...
function displayCheckoutItems(){
    ...
    document.getElementById('checkout-details').innerHTML = checkoutArray.map((checkoutItem) => {
...
function removeItemFromCheckoutArray(checkoutItemId){
    ...
    const itemToRemove = checkoutArray.find((checkoutItem) => 
    checkoutItem.id === checkoutItemId)
